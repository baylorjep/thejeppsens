...
const RAW_BOARD: Array<[name: string, ovr: number, espnId: string, ratingSource?: string]> = [
  ['Josh Allen', 99, '3918298', RATING_SOURCE_OFFICIAL],
  ['Matthew Stafford', 99, '12483', RATING_SOURCE_OFFICIAL],
  ['Joe Burrow', 97, '3915511', RATING_SOURCE_OFFICIAL],
  ['Lamar Jackson', 94, '3916387', RATING_SOURCE_OFFICIAL],
  ['Patrick Mahomes', 93, '3139477', RATING_SOURCE_OFFICIAL],
  ['Drake Maye', 92, '4431452', RATING_SOURCE_OFFICIAL],
  ['Dak Prescott', 91, '2577417', RATING_SOURCE_OFFICIAL],
  ['Caleb Williams', 90, '4431611', RATING_SOURCE_OFFICIAL],
  ['Justin Herbert', 90, '4038941', RATING_SOURCE_OFFICIAL],
  ['Jared Goff', 88, '3046779', RATING_SOURCE_OFFICIAL],
