...
const RAW_BOARD: Array<[name: string, ovr: number, espnId: string, ratingSource?: string]> = [
  ["Ja'Marr Chase", 99, '4362628', RATING_SOURCE_OFFICIAL],
  ['Jaxon Smith-Njigba', 99, '4430878', RATING_SOURCE_OFFICIAL],
  ['Puka Nacua', 98, '4426515', RATING_SOURCE_OFFICIAL],
  ['Amon-Ra St. Brown', 95, '4374302', RATING_SOURCE_OFFICIAL],
  ['Justin Jefferson', 94, '4262921', RATING_SOURCE_OFFICIAL],
  ['CeeDee Lamb', 93, '4241389', RATING_SOURCE_OFFICIAL],
  ['DeVonta Smith', 92, '4241478', RATING_SOURCE_OFFICIAL],
  ['Drake London', 92, '4426502', RATING_SOURCE_OFFICIAL],
  ['Mike Evans', 91, '16737', RATING_SOURCE_OFFICIAL],
  ['Terry McLaurin', 91, '3121422', RATING_SOURCE_OFFICIAL],
