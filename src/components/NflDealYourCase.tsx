export default function NflDealYourCase({ number }: { number: number }) {
  return (
    <div className="mx-auto flex w-fit items-center gap-4 rounded-xl border border-amber-400/40 bg-gradient-to-br from-amber-500/10 to-slate-900 px-5 py-3 shadow-[0_0_24px_rgba(251,191,36,0.15)]">
