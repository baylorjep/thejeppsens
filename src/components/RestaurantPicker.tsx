      ...
      <div className="max-w-6xl mx-auto">
        ...
        {result && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={() => setResult(null)}>
            <div className="bg-white rounded-2xl p-10 shadow-2xl max-w-md w-full text-center" onClick={(e) => e.stopPropagation()}>
              <p className="text-sm font-semibold text-gray-400 uppercase tracking-widest mb-3">Tonight we&apos;re eating at</p>
              ...
              <div className="flex gap-3 justify-center">
                <button
                  onClick={pickRandom}
                  className="px-5 py-2.5 bg-gray-700 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors"
                >
                  Pick Again
                </button>
                <button
