...
export default function TravelEditButton({ type, item, label = "Edit" }: EditItem & { label?: string }) {
  return (
    <button
      ...
      className="inline-flex items-center justify-center rounded-md p-1.5 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-950 focus:outline-none focus:ring-2 focus:ring-teal-500"
    >
