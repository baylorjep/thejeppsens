...
export default async function PressingQueuePage() {
  ...
  return <main className="min-h-screen bg-white"><Header /><section className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
    ...
    <p className="mt-4 leading-7 text-gray-600">Find the exact edition of a record you own. Choose an album below, then follow the photo guide one side at a time. No record-collecting knowledge needed — Baylor will do the research.</p>
    <ol className="mt-6 grid gap-3 text-sm sm:grid-cols-3"><li className="rounded-xl bg-stone-100 p-4"><strong>1. Choose your album</strong><p className="mt-2 text-gray-600">Have your physical copy and phone handy.</p></li><li className="rounded-xl bg-stone-100 p-4"><strong>2. Follow the photo guide</strong><p className="mt-2 text-gray-600">We’ll show you exactly where to look. Save a draft at any time.</p></li><li className="rounded-xl bg-stone-100 p-4"><strong>3. Submit for review</strong><p className="mt-2 text-gray-600">Tell Baylor it’s ready so he can identify your copy.</p></li></ol>
